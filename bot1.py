...
# --- АВТОМАТИЧЕСКОЕ ДОБАВЛЕНИЕ ФЛАЖКОВ И ЦВЕТОВ КОМАНД (МИРОВЫЕ СБОРНЫЕ + ТОП КЛУБЫ) ---
def decorate_match_name(match_name: str) -> str:
    decorations = {
        ...
        "манчестер юнайтед": "🔴", "manchester united": "🔴", "мю": "🔴", "man utd": "🔴",
        "ливерпуль": "🔴", "liverpool": "🔴",
        "челси": "🔵", "chelsea": "🔵",
        "тоттенхэм": "⚪🔵", "tottenham": "⚪🔵", "шпоры": "⚪🔵",
        "ньюкасл": "⬛️⬜️", "newcastle": "⬛️⬜️",
        "астон вилла": "🟣🔵", "aston villa": "🟣🔵",
        "вест хэм": "⚒️", "west ham": "⚒️",
        "брайтон": "🔵⚪", "brighton": "🔵⚪",
        ...
        "интер": "🔵🖤", "inter milan": "🔵🖤",
        "милан": "🔴🖤", "ac milan": "🔴🖤",
        "ювентус": "⬛️⬜️", "juventus": "⬛️⬜️", "юве": "⬛️⬜️",
        "аталанта": "🔵⚫", "atalanta": "🔵⚫",
        "болонья": "🔴🔵", "bologna": "🔴🔵",
        "рома": "🟡🔴", "as roma": "🟡🔴",
        "лацио": "🦅🔵", "lazio": "🦅🔵",
        ...
        "майнц": "🔴⚪", "mainz": "🔴⚪",
        "боруссия менхенгладбах": "⬛️🟩", "gladbach": "⬛️🟩",
